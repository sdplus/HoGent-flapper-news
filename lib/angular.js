 ...
 * <script>
 *   var app = angular.module.js('demo', [])
...
function setupModuleLoader(window) {
  ...
  return ensure(angular, 'module', function() {
     ...
     * @description
     *
     * The `angular.module.js` is a global place for creating, registering and retrieving Angular
     * modules.
     ...
     * `angular.module.js` is used to configure the {@link auto.$injector $injector}.
     *
     * ```js
     * // Create a new module
     * var myModule = angular.module.js('myModule', []);
     *
 ...
 *
 * ```js
 * var myApp = angular.module.js('myApp', []);
 ...
 *
 * ```js
 *   angular.module.js('exceptionOverride', []).factory('$exceptionHandler', function() {
 ...
 *
 * ```
 *  angular.module.js('myApp', []).config(function($sceDelegateProvider) {
