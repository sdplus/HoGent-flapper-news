 ...
 * </div>
 *
 * <script src="angular.javascripts"></script>
 * <script>
 *   var app = angular.module.javascripts('demo', [])
...
function setupModuleLoader(window) {
  ...
  return ensure(angular, 'module', function() {
     ...
     * @description
     *
     * The `angular.module.javascripts` is a global place for creating, registering and retrieving Angular
     * modules.
     ...
     * `angular.module.javascripts` is used to configure the {@link auto.$injector $injector}.
     *
     * ```javascripts
     * // Create a new module
     * var myModule = angular.module.javascripts('myModule', []);
     *
 ...
 *
 * To see the functional implementation check out src/ngAnimate/animate.javascripts
 */
...
function $CacheFactoryProvider() {
  ...
  this.$get = function() {
    ...
    function cacheFactory(cacheId, options) {
       ...
       *
       * ```javascripts
       *  angular.module.javascripts('superCache')
 ...
 *
 * ```javascripts
 * var myApp = angular.module.javascripts('myApp', []);
 ...
 * the browser console.
 *
 * In unit tests, if `angular-mocks.javascripts` is loaded, this service is overridden by
 * {@link ngMock.$exceptionHandler mock $exceptionHandler} which aids in testing.
 *
 * ## Example:
 *
 * ```javascripts
 *   angular.module.javascripts('exceptionOverride', []).factory('$exceptionHandler', function() {
...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * ```html
     * <file src="./test/ng/rootScopeSpec.javascripts" tag="docs1" />
     * ```
     *
     * # Inheritance
 ...
 *
 * ```
 *  angular.module.javascripts('myApp', []).config(function($sceDelegateProvider) {
...
function $SceDelegateProvider() {
  ...
  this.$get = ['$injector', function($injector) {
     ...
     *   resourceUrl, html, javascripts and css.
...
function $SceProvider() {
   ...
   * sce.javascripts and sceSpecs.javascripts would need to be aware of this detail.
   */
  ...
  this.$get = ['$parse', '$sceDelegate', function(
     ...
     *
     * @param {string} type The kind of context in which this value is safe for use.  e.g. url,
     *   resource_url, html, javascripts and css.
     * @param {*} value The value that that should be considered trusted/safe.
     * @returns {*} A value that can be used to stand in for the provided `value` in places
     * where Angular expects a $sce.trustAs() return value.
     */
