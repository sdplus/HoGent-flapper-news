 ...
 * @description
 *
 * Namespace from 'angular-mocks.javascripts' which contains testing related code.
 */
angular.mock = {};
 ...
 *
 * ```javascripts
 *   myAppDev = angular.module.javascripts('myAppDev', ['myApp', 'ngMockE2E']);
...
if (window.jasmine || window.mocha) {
   ...
   * ```javascripts
   *
   *   angular.module.javascripts('myApplicationModule', [])
   *       .value('mode', 'app')
